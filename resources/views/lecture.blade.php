...
<body class="containeur2">
	...
	<div class="ecran3">
		...
		@foreach($lecture as $lec)
		 	<div class="film">
				<div class="movie-image movie-image-1" style="background: url({{$lec->lien_affiche}}); height: 200px; background-size: cover; background-repeat: no-repeat; object-fit: cover">
					<span> <i class="fa fa-align-left"></i></span>
				</div>
				<div class="movie-info">
					<p class="titre">{{$lec->titre}}</p>
					<p class="genre">{{$lec->categorie}}</p>
