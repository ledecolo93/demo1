		...
		@foreach($resultatFinal as $cat)
			<div class="film">
				...
				<div class="movie-info">
					...
					<div class="summary">
						<p class="text">
							Nombre de video {{$cat->nom}} : {{$cat->nbreFichier}}
						</p>
					</div>
					<div class="actions">
						<button onclick="window.location='/video/categorie/sous-categorie/fichier/{{$cat->id}}'" style="font-size: 10px;"><i class="fa fa-play"></i>Voir Film</button>
