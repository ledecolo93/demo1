	...
	<div class="ecran4">
			...
			@foreach($lecture as $lec)
			 	<div class="espace_lecteur">
			 		<div class="lecteur">
			 			<object id="myLecture" data="{{$lec->lien_fichier}}" height="600px" width="800px" type="text/html" codetype="application/pdf"> </object>
			 		</div>
			 	</div>
			@endforeach
		...
		<div class="slid owl-carousel">
			...
			@foreach($lectures as $lec)
			 	<div class="film2">
					<div class="movie-image movie-image-1" style="background: url({{$lec->lien_affiche}}); height: 200px; background-size: cover; background-repeat: no-repeat;">
						<span> <i class="fa fa-align-left"></i></span>
					</div>
					<div class="movie-info">
						<p class="titre" style="color: yellow;">{{$lec->titre}}</p>
						<div class="actions">
							<button onclick="window.location='/lecture/item/{{$lec->id}}'"><i class="fa fa-play"></i> Voir livre</button>
						</div>
					</div>
				</div>
			@endforeach
